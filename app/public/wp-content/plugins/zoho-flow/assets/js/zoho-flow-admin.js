...
function copyApiKey(){
	var temp=document.createElement('input');
  	...
  	temp.remove();
  	jQuery("#copy-api-key-sucess").hide(); //No I18N
		//jQuery("#copy-api-key-sucess").show(); //No I18N
		jQuery("#copy-api-key-sucess").css({"display":"inline-block"}); //No I18N
		setTimeout(function(){
			jQuery("#copy-api-key-sucess").hide(); //No I18N
		}, 1000);
}
...
function copySiteUrl(){
	var temp=document.createElement('input');
  	...
  	document.execCommand("copy"); //No I18N
  	temp.remove();
  	jQuery("#copy-site-url-sucess").hide(); //No I18N
		//jQuery("#copy-site-url-sucess").show(); //No I18N
		jQuery("#copy-site-url-sucess").css({"display":"inline-block"}); //No I18N
		setTimeout(function(){
			jQuery("#copy-site-url-sucess").hide(); //No I18N
		}, 1000);
}
