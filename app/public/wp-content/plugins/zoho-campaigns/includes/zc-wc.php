...
switch ($end) {
      ...
      { ?>
          ...
          <p><?php echo get_option("zcwc_error_msg");?></p>
     ...
     <div class=" p20 ">
        <div class="zcbigwizrdcont">
              <div class="zcbigwizrd">
                  <div class="zcbwpoint <?php echo $ActiveClassess[0] ?> ">
                      <div class="zcbwstage"><span>Connect</span></div>
                  </div>
                  <div class="zcbwline <?php echo $ActiveClassess[1] ?>"> </div>
                  <div class="zcbwpoint <?php echo $ActiveClassess[2] ?>">
                      <div class="zcbwstage"><span>Select List</span></div>
                  </div>
                  <div class="zcbwline <?php echo $ActiveClassess[3] ?>"></div>
                  <div class="zcbwpoint <?php echo $ActiveClassess[4] ?>">
                                      ...
                                      <ul id="pagecheck">
                                                    ...
                                                    <?php  } else {
                                                      foreach($zcwc_lists as $key => $value){ ?>
                                                        <li value="<?php echo $value; ?>" onclick="zcwc_setvalue('<?php echo $value;?>','<?php echo $key; ?>');" > <?php echo $key; ?> </li>
                                                   <?php   } }?>
                                      </ul>
                                  </div>
                                </div>
 ...
 <?php } else {?>
  <div class="p30 ">
    ...
    <!--     <div>
        ...
        <div class="vm"><?php if(ZohoCampaign_Admin::zcwc_get_parsed_val('zcwc_store_stats','last_sync_time'))echo get_date_from_gmt( date( 'Y-m-d H:i:s', substr(ZohoCampaign_Admin::zcwc_get_parsed_val('zcwc_store_stats','last_sync_time'), 0 , -3)), get_option('date_format')); else echo "<font color='green'>Syncing in progress</font>" ?>
        ...
        <div class=" f16 fntwht400 mt20">Orders</div><div class="f26   tc mt10 fntwht400"><?php echo ZohoCampaign_Admin::zcwc_get_parsed_val('zcwc_store_stats','order_count'); ?></div>
        </div></div>
        <div class="clr"></div>
        </div>
        ...
        <div class="f28   tc fntwht400"><?php echo ZohoCampaign_Admin::zcwc_get_parsed_val('zcwc_store_stats','product_count'); ?></div>
        </div></div>
        <div class="clr"></div>
        </div>
        </div><div class=" vt">
        ...
        <div class="f28   tc mt10 fntwht400"><?php echo ZohoCampaign_Admin::zcwc_get_parsed_val('zcwc_store_stats','non_marketing_customers'); ?></div>
        <div class="f14 mt10">Marketing Not Allowed</div>
        </div><div class=" w50 fl">
        <div class="f28 tc mt10 fntwht400">
        <?php echo ZohoCampaign_Admin::zcwc_get_parsed_val('zcwc_store_stats','marketing_customers'); ?></div>
        ...
        <div class="zcoptsetvalcot mb20 mt30">
            ...
            <div class="zcoptsetval">
                <textarea class="zcwc_optin_msg" placeholder="Subscribe to our newsletter"><?php echo ZohoCampaign::zcwc_get_parsed_val('zcwc_optin_setting', 'label'); ?></textarea>
            </div>
        </div>
        ...
        <div class="zcoptsetvalcot">
            <div class="zcoptsetval">
             ...
             <div class="zcoptsetval">
                <input class="zcwc_optin_hook" type="text" value="<?php echo ZohoCampaign::zcwc_get_parsed_val('zcwc_optin_setting', 'hook'); ?>">
            </div>
        </div>
      </div>
    </div>
